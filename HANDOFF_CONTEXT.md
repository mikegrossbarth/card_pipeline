...
- Profit graph options now include `Profit by Company`, which groups filtered sold-card profit by company/buyer, skips expenses, and renders a bar chart so company-level profitability is visible without exporting.
