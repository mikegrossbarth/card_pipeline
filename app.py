...
class CardPipelineApp(tk.Tk):
    ...
    def _build_profit_tab(self) -> None:
        ...
        if not self._is_personal_lucas():
            ttk.Label(controls, text="View", style="Muted.TLabel").grid(row=0, column=14, sticky="e", padx=(18, 6))
            ...
            self.profit_owner_view_combo.grid(row=0, column=15, sticky="w")
        ...
        ttk.Label(controls, textvariable=self.profit_metric_var, style="Panel.TLabel").grid(row=1, column=0, columnspan=17, sticky="w", pady=(10, 0))
        ttk.Label(controls, textvariable=self.profit_status_var, style="Muted.TLabel").grid(row=2, column=0, columnspan=17, sticky="w", pady=(6, 0))
